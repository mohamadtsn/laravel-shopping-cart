...
class CartTest extends TestCase
{
    ...
    public function test_cart_update_with_attribute_then_attributes_should_be_still_instance_of_ItemAttributeCollection()
    {
        ...
        $this->assertInstanceOf('Mohamadtsn\ShoppingCart\ItemAttributeCollection', $item->attributes);
    }
    ...
    {
        $this->expectException('Mohamadtsn\ShoppingCart\Exceptions\InvalidItemException');
