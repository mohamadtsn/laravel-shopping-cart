<?php namespace Mohamadtsn\ShoppingCart;
...
class CartServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('cart', function ($app) {
            ...
            // like when adding a cart for a specific username. Session Key can be string or maybe a unique identifier to bind a cart
